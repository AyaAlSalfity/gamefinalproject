...
public class MusicePlayService extends Service implements MediaPlayer.OnCompletionListener,MediaPlayer.OnPreparedListener,MediaPlayer.OnErrorListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnInfoListener,
        MediaPlayer.OnBufferingUpdateListener{
    public MusicePlayService() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mediaPlayer.reset();
        musicStopListener=(MusicStopListener) ApplictionClass.context;
